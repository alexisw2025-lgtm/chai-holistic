...
export default function ComingSoon() {
  ...
  useEffect(() => {
    const t = setInterval(() => setActiveFeature(i => (i + 1) % TEASERS.length), 3800);
    return () => clearInterval(t);
  }, []);
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .teaser-card.unlocked:hover {
          border-color: rgba(192,136,48,.55) !important;
        }
        .teaser-card.locked:hover {
