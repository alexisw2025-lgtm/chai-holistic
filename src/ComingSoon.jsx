      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <img src="/chai_holistic.jpg" alt="Chai Holistic" style={{width:"100%",height:"100%",objectFit:"cover"}}/>
          </div>
        </div>
        ...
        >
          <div style={{
            ...
            textTransform: "uppercase", color: "rgba(192,136,48,.5)",
          ...
          <div style={{
            ...
            We're not ready to show you everything. But here's enough to make you stay.
          </div>
          ...
          <div style={{
            ...
            {TEASERS.map((t, i) => (
              <div key={i} style={{
                background: t.locked
                  ? "rgba(255,255,255,.02)"
                  : "linear-gradient(135deg, rgba(39,92,62,.2), rgba(23,51,34,.3))",
                border: t.locked
                  ? "1px solid rgba(255,255,255,.07)"
                  : "1px solid rgba(192,136,48,.25)",
                borderRadius: 18,
                padding: "22px 18px",
                textAlign: "center",
                position: "relative",
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.borderColor = t.locked ? "rgba(255,255,255,.15)" : "rgba(192,136,48,.5)";
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = "";
                e.currentTarget.style.borderColor = t.locked ? "rgba(255,255,255,.07)" : "rgba(192,136,48,.25)";
              }}>
                ...
                {/* Icon */}
                <div style={{
                  fontSize: t.locked ? "1.6rem" : "2rem",
                  marginBottom: 10,
                  filter: t.locked ? "grayscale(1) opacity(0.3)" : "none",
                ...
                <div style={{
                  ...
                  color: t.locked ? "rgba(255,255,255,.2)" : "rgba(192,136,48,.8)",
                  marginBottom: 8,
                  filter: t.locked ? "blur(2.5px)" : "none",
                }}>
                  {t.label}
                </div>
                ...
                <div style={{
                  ...
                  fontStyle: "italic",
                  fontSize: ".82rem",
                  color: t.locked ? "rgba(255,255,255,.12)" : "rgba(255,255,255,.55)",
                  lineHeight: 1.6,
                  filter: t.locked ? "blur(3px)" : "none",
                  userSelect: t.locked ? "none" : "auto",
                }}>
                  {t.teaser}
                </div>
          ...
          <div style={{
            ...
            The locked cards? Worth the wait. Join the waitlist to be first.
          </div>
        </div>
...
// ─── Teaser data ──────────────────────────────────────────────────────────────
const TEASERS = [
  { icon: "🍵", label: "40+ Herbal Blends",     locked: false, teaser: "Small-batch teas crafted for sleep, stress, focus, and healing. Every cup has a purpose." },
  { icon: "🌿", label: "Sea Moss Gel Kits",      locked: false, teaser: "92 of 102 minerals. A Caribbean grandmother's recipe. Now yours." },
  { icon: "🌊", label: "Herb Jelly Kits",        locked: false, teaser: "Healing in a different form. Beautiful, natural, and impossibly satisfying to make." },
  { icon: "💫", label: "Vibe Shift Rings",       locked: false, teaser: "Wear your intention. Feel the shift. Nine frequencies. One ring." },
  { icon: "⚡", label: "Men's Wellness",         locked: false, teaser: "20 blends built for the male body. No compromise. No fluff. Just results." },
  { icon: "🌙", label: "2AM Companion",          locked: true,  teaser: "For the nights when sleep won't come and you need something real. Something that listens." },
  { icon: "💊", label: "The Apothecary",         locked: true,  teaser: "Something deeper is coming. Curated. Intentional. Designed to complete the protocol." },
  { icon: "📱", label: "The Chai App",           locked: true,  teaser: "Your entire wellness world. One place. One profile. Always with you." },
  { icon: "🔬", label: "Resonance Health",       locked: true,  teaser: "We're working with technology that reads what your body is actually saying. Stay close." },
  { icon: "✦",  label: "Sip & Heal Report",     locked: false, teaser: "Tell us how you feel. We'll tell you exactly what your body needs. Free. Always." },
];
